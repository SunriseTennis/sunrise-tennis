...
const statusStyles: Record<string, string> = {
  ...
  registered: 'bg-success-light text-success border-success/20',
  nominated: 'bg-success-light text-success border-success/20',
  ...
  nominations_open: 'bg-info-light text-info border-info/20',
  in_season: 'bg-primary text-white border-primary',
  mainstay: 'bg-info-light text-info border-info/20',
  pending: 'bg-warning-light text-warning border-warning/20',
  fill_in: 'bg-warning-light text-warning border-warning/20',
  ...
  unregistered: 'bg-danger-light text-danger border-danger/20',
